...
extern "C" SEXP _dummypackage_ols_mat_(SEXP y, SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_ols_dbl_(SEXP y, SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_eigen_sym_mat(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_eigen_sym_dbl(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_eigen_gen_mat(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_eigen_gen_mat_complex_wrapper(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_eigen_gen_dbl_complex_wrapper(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_eigen_gen_no_wrapper(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_chol_mat(SEXP x, SEXP type) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_ols_qr_mat(SEXP y, SEXP x, SEXP econ) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_ols_qr_dbl(SEXP y, SEXP x, SEXP econ) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_capm(SEXP r, SEXP m, SEXP f) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_typedef_Col_double(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_typedef_Col_int(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_typedef_uvec(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_typedef_Mat_double(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_typedef_Mat_int(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_typedef_SpMat_double(SEXP x) {
  BEGIN_CPP11
...
extern "C" SEXP _dummypackage_typedef_SpMat_int(SEXP x) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_dummypackage_capm",                          (DL_FUNC) &_dummypackage_capm,                          3},
    {"_dummypackage_chol_mat",                      (DL_FUNC) &_dummypackage_chol_mat,                      2},
    {"_dummypackage_eigen_gen_dbl_complex_wrapper", (DL_FUNC) &_dummypackage_eigen_gen_dbl_complex_wrapper, 1},
    {"_dummypackage_eigen_gen_mat",                 (DL_FUNC) &_dummypackage_eigen_gen_mat,                 1},
    {"_dummypackage_eigen_gen_mat_complex_wrapper", (DL_FUNC) &_dummypackage_eigen_gen_mat_complex_wrapper, 1},
    {"_dummypackage_eigen_gen_no_wrapper",          (DL_FUNC) &_dummypackage_eigen_gen_no_wrapper,          1},
    {"_dummypackage_eigen_sym_dbl",                 (DL_FUNC) &_dummypackage_eigen_sym_dbl,                 1},
    {"_dummypackage_eigen_sym_mat",                 (DL_FUNC) &_dummypackage_eigen_sym_mat,                 1},
    {"_dummypackage_ols_dbl_",                      (DL_FUNC) &_dummypackage_ols_dbl_,                      2},
    {"_dummypackage_ols_mat_",                      (DL_FUNC) &_dummypackage_ols_mat_,                      2},
    {"_dummypackage_ols_qr_dbl",                    (DL_FUNC) &_dummypackage_ols_qr_dbl,                    3},
    {"_dummypackage_ols_qr_mat",                    (DL_FUNC) &_dummypackage_ols_qr_mat,                    3},
    {"_dummypackage_typedef_Col_double",            (DL_FUNC) &_dummypackage_typedef_Col_double,            1},
    {"_dummypackage_typedef_Col_int",               (DL_FUNC) &_dummypackage_typedef_Col_int,               1},
    {"_dummypackage_typedef_Mat_double",            (DL_FUNC) &_dummypackage_typedef_Mat_double,            1},
    {"_dummypackage_typedef_Mat_int",               (DL_FUNC) &_dummypackage_typedef_Mat_int,               1},
    {"_dummypackage_typedef_SpMat_double",          (DL_FUNC) &_dummypackage_typedef_SpMat_double,          1},
    {"_dummypackage_typedef_SpMat_int",             (DL_FUNC) &_dummypackage_typedef_SpMat_int,             1},
    {"_dummypackage_typedef_uvec",                  (DL_FUNC) &_dummypackage_typedef_uvec,                  1},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_dummypackage(DllInfo* dll){
